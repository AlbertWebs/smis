...
<title>S.M.I.S - Get access to your Students, Attendance, Book Exams, Payments, Receipts, and More.</title>
    ...
    <div class="row g-0 min-vh-100 py-4 py-md-5">
      ...
      <div class="col-lg-7 shadow-lg">
        <div class="hero-wrap d-flex align-items-center rounded-3 rounded-end-0 h-100">
          ...
          <div class="hero-bg hero-bg-scroll" style="background-image:url('{{asset('logins/images/login-bgs.jpg')}}');"></div>
          <div class="hero-content mx-auto w-100 h-100 d-flex flex-column">
            <div class="row g-0">
              <div class="col-11 col-lg-10 mx-auto">
                <div class="logo mt-5 mb-5 mb-lg-0"> <a style="color:#ffffff; font-size: 2.75rem !important; font-weight:800" href="#" title="Oxyy">S.M.I.S</a> </div>
              </div>
            </div>
            <div class="row g-0 my-auto">
              <div class="col-11 col-lg-10 mx-auto">
                <h1 class="text-11 text-white mb-3">Welcome back!</h1>
                <p class="text-5 text-white lh-base mb-4">Get access to your Students, Attendance, Book Exams, Payments, Receipts, and More.</p>
          ...
          <div class="row">
            <div class="col-11 col-lg-10 mx-auto">
              ...
              <div class="d-flex align-items-center my-3">
                ...
                <span class="mx-2 text-2 text-muted">Or Sign In with Social Profile</span>
                <hr class="flex-grow-1 bg-dark-4">
              </div>
